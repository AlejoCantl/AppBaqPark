          ...
          >
            ...
            <View style={styles.infoSection}>
              <View style={styles.infoSectionHeader}>
                <Ionicons name="body-outline" size={20} color={theme.colors.secondary} />
            ...
            <View style={styles.infoSection}>
              <View style={styles.infoSectionHeader}>
                <Ionicons name="construct-outline" size={20} color={theme.colors.secondary} />
            ...
            <View style={[styles.infoSection, styles.noteSection]}>
              <View style={styles.infoSectionHeader}>
                ...
                <Text style={[styles.infoTitle, { color: theme.colors.warning }]}>Nota Importante</Text>
              </View>
